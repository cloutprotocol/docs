...
description: "Extending INK agents with plugins"
---

Plugins are the primary extension mechanism for INK agents. They allow you to add new capabilities without modifying core agent logic.
...
INK has three categories of plugins:

### Official Plugins

Maintained by the INK team, guaranteed compatibility:

- **@ink/plugin-twitter** - Twitter posting and interaction
- **@ink/plugin-discord** - Discord bot integration
- **@ink/plugin-telegram** - Telegram bot integration
- **@ink/plugin-news** - Multi-source news aggregation
- **@ink/plugin-trading** - Paper and live trading

### Community Plugins

Built by the community, varying quality:

- **ink-plugin-reddit** - Reddit monitoring and posting
- **ink-plugin-openai** - OpenAI API integration
- **ink-plugin-midjourney** - AI image generation
- **ink-plugin-polymarket** - Prediction market integration
...
<CardGroup cols={2}>
  <Card title="Official Plugins" icon="check" href="/plugins/official">
    Production-ready plugins from the INK team.
  </Card>
