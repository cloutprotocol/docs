...
Plugins are the primary way to extend INK agents with custom functionality. This guide covers everything you need to build production-ready plugins.

## Plugin Anatomy

Every INK plugin implements a simple interface:
